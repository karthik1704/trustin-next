  ...
  const ExemptedInvoiceParameterTable: React.FC<InvoiceParameterTableProps> = ({
    parameters,
    currency,
    invoice_type,
    tested_type,
    ...
    <View style={styles.table}>
      <View style={[styles.tableRow, styles.tableHeader]}>
        ...
        <View style={[styles.tableCol, { width: "15%" }]}>
          <Text style={styles.tableCell}>Testing Charge / Test({currency})</Text>
        </View>
        <View style={[styles.tableCol, { width: "15%" }]}>
  ...
  export default ExemptedInvoiceParameterTable;
