...
const OtherStateInvoiceParameterTable: React.FC<InvoiceParameterTableProps> = ({
  parameters,
  currency,
  invoice_type,
  tested_type,
  ...
  <View style={styles.table}>
    <View style={[styles.tableRow, styles.tableHeader]}>
      ...
      <View style={[styles.tableCol, { width: "15%" }]}>
        <Text style={styles.tableCell}>Testing Charge / Batch(INR)</Text>
      </View>
      <View style={[styles.tableCol, { width: "15%" }]}>
...
export default OtherStateInvoiceParameterTable;
