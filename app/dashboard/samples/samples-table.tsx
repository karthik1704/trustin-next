          ...
          <tbody>
            {data.data.map((packageItem, key) => (
              <tr key={packageItem.id}>
                <td className="border-b border-slate-400 px-4 py-3 pl-9 dark:border-strokedark xl:pl-11">
                  <Link
                ...
                <td className="border-b border-slate-400 px-4 py-3 dark:border-strokedark">
