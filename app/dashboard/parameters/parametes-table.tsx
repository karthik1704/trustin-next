...
const ParametersTable = ({ data }: { data: ParametersType }) => {
  return (
    <div className="rounded-sm border border-stroke bg-white px-2 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              <th className="w-[70px] py-4 px-4 font-medium text-black dark:text-white">
                Test Type
              </th>
              <th className="w-[80px] py-4 px-4 font-medium text-black dark:text-white">
                Amount
              </th>
              <th className="w-[80px] py-4 px-4 font-medium text-black dark:text-white">
                Actions
