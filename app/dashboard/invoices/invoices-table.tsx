...
const InvoiceTable = ({ data }: { data: Data }) => {
          ...
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              {/* <th
                ...
                className="min-w-[120px] px-4 py-4 pl-0 font-medium text-black dark:text-white lg:pl-9"
              >
                Status
              </th> */}
          ...
          <tbody>
            {data.data.map((packageItem, key) => (
              <tr key={packageItem.id}>
                ...
                <td className="border-b border-slate-400 px-4 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">
                    {packageItem.invoice_mode === "INVOICE" ? invoiceTypes[packageItem?.invoice_type as keyof typeof invoiceTypes] ?? "" : proformaInvoiceTypes[packageItem?.invoice_type as keyof typeof proformaInvoiceTypes] ?? ""}
                  </p>
                </td>
                <td className="border-b border-slate-400 px-4 py-5 dark:border-strokedark">
                  <p
